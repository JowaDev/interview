    ...
    return (
        function (createFFmpegCore) {
            ...
            if (l) {
                ...
                return a
            }, "undefined" != typeof scriptArgs ? ja = scriptArgs :
                "undefined" != typeof arguments && (ja = arguments), "function" === typeof quit && (la = function (a) {
                quit(a)
            ...
            var ea = f.print || console.log.bind(console), h = f.printErr || console.warn.bind(console);
            ...
            function mb() {
                return Ba || !ma && !oa || "function" !== typeof fetch || ib("file://") ? Promise.resolve().then(lb) : fetch(jb, {credentials: "same-origin"}).then(function (a) {
            ...
            function vb(a, b) {
                ...
                var c = Atomics.load(D, L.Vf >> 2), d = 0;
            ...
            var L = {
                Ph: 1, nj: {Ih: 0, Jh: 0}, Gf: [], Kf: [], lj: function () {
                }, pi: function () {
                    L.xf = Oa(232);
                    ...
                    for (; 0 <
                           L.Dg.length;) L.Dg.pop()();
                    n && threadInfoStruct && Ab()
                }, Qi: function (a) {
                    var b = rb | 0;
                    b && (Atomics.store(E, b + 4 >> 2, a), Atomics.store(E, b + 0 >> 2, 1), Atomics.store(E, b + 60 >> 2, 1), Atomics.store(E, b + 64 >> 2, 0), L.eh(), vb(b + 0, 2147483647), ub(0, 0, 0), threadInfoStruct = 0, n && postMessage({cmd: "exit"}))
                }, Pi: function () {
                    L.eh();
                ...
                Ii: function () {
                    ...
                    a.onmessage = function (c) {
                        ...
                        if (d.targetThread && d.targetThread != (rb | 0)) {
                        ...
                        } else if ("processQueuedMainThreadWork" === e) Cb(); else if ("spawnThread" === e) Db(c.data); else if ("cleanupThread" === e) xb(d.thread); else if ("killThread" ===
                            e) {
                            c = d.thread;
                            ...
                            c.worker.yf = void 0
                        } else if ("cancelThread" === e) wb(d.thread); else if ("loaded" === e) a.loaded = !0, b && b(a), a.og && (a.og(), delete a.og); else if ("print" === e) ea("Thread " + d.threadId + ": " + d.text); else if ("printErr" === e) h("Thread " + d.threadId + ": " + d.text);
                        else if ("alert" === e) alert("Thread " + d.threadId + ": " + d.text); else if ("exit" === e) a.yf && Atomics.load(E, a.yf.Lh + 68 >> 2) && L.Ag(a); else if ("exitProcess" === e) {
                            noExitRuntime = !1;
                            try {
                                da(d.returnCode)
                            } catch (k) {
            ...
            var Zb = {
                    ...
                    xh: function (a) {
                        if (!a.input.length) {
                            var b = null;
                            if (l) {
                                var c = Buffer.Sf ? Buffer.Sf(256) : new Buffer(256), d = 0;
                                try {
                    ...
                    Df: null, jf: function () {
                        ...
                        read: function (a, b, c, d, e) {
                            ...
                            if (a.bf.subarray && b.subarray) a.bf.set(b.subarray(c,
                                c + d), e); else for (g = 0; g < d; g++) a.bf[e + g] = b[c + g];
                    ...
                    ff: function (a, b) {
                        ...
                        for (d = 0; d < a.length; d++) {
                            ...
                            if (!g || b.wf) for (g =
                                                     0; N.Mf(e.mode);) if (e = N.readlink(c), c = Vb(Rb(c), e), e = N.ff(c, {ah: b.ah}).node, 40 < g++) throw new N.af(32);
                        }
                    ...
                    zi: function (a, b) {
                        return a ?
                            N.Mf(a.mode) ? 32 : N.kf(a.mode) && ("r" !== N.th(b) || b & 512) ? 31 : N.Jf(a, N.th(b)) : 44
                    },
                    Qh: 4096,
                    Bi: function (a, b) {
                        b = b || N.Qh;
                    ...
                    Kh: function (a, b) {
                        ...
                        N.Cg++;
                        1 < N.Cg && h("warning: " +
                            N.Cg + " FS.syncfs operations in flight at once, probably just doing extra work");
                        var e = N.wh(N.root.jf), g = 0;
                    ...
                    rename: function (a, b) {
                        var c = Rb(a), d = Rb(b), e = Sb(a), g = Sb(b);
                    ...
                    rmdir: function (a) {
                        var b = N.ff(a, {parent: !0}).node, c = Sb(a), d = N.Bf(b, c), e = N.xg(b, c, !0);
                        if (e) throw new N.af(e);
                    ...
                    unlink: function (a) {
                        var b = N.ff(a,
                            {parent: !0}).node, c = Sb(a), d = N.Bf(b, c), e = N.xg(b, c, !1);
                        if (e) throw new N.af(e);
                    ...
                    open: function (a, b, c, d, e) {
                        ...
                        try {
                            N.mf.onOpenFile && (e = 0, 1 !== (b & 2097155) && (e |= N.Mh.Gh.Rh), 0 !== (b & 2097155) && (e |= N.Mh.Gh.Sh),
                                N.mf.onOpenFile(a, e))
                        } catch (m) {
                    ...
                    ei: function () {
                        ...
                        f.stdin ? N.Hf("/dev", "stdin", f.stdin) : N.symlink("/dev/tty",
                            "/dev/stdin");
                    ...
                    Lg: function (a, b) {
                        ...
                        try {
                            c = N.ff(a, {parent: !0}), d.Ci = !0, d.Ei = c.path, d.Di = c.node, d.name = Sb(a), c = N.ff(a, {wf: !b}), d.exists = !0, d.path = c.path, d.object = c.node, d.name = c.node.name, d.wg = "/" === c.path
                        } catch (e) {
                            d.error = e.ef
                        }
                        return d
                    ...
                    bj: function (a, b, c, d, e) {
                        ...
                        g.prototype.kh = function () {
                            ...
                            if (!(200 <= q.status && 300 > q.status || 304 === q.status)) throw Error("Couldn't load " +
                                c + ". Status: " + q.status);
                            var t = Number(q.getResponseHeader("Content-length")), w,
                    ...
                    wj: function (a, b,
                        ...
                        e.onsuccess = function () {
                            var g = e.result.transaction([N.eg], "readwrite"), k = g.objectStore(N.eg), m = 0, r = 0,
                                q = a.length;
                    ...
                    mj: function (a, b, c) {
                        ...
                        e.onsuccess = function () {
                            ...
                            var m = k.objectStore(N.eg), r = 0, q = 0, t = a.length;
            ...
            function mc(a, b) {
                ...
                try {
                    ...
                    if (b & -8) var c = -28; else {
                        var d;
                        (d = N.ff(a, {wf: !0}).node) ? (a = "", b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), c = a && N.Jf(d, a) ? -2 : 0) : c = -44
                    }
                    return c
                } catch (e) {
            ...
            function pc(a, b, c) {
                ...
                try {
                    ...
                    for (var e = N.tf(d, 0, 1), g = Math.floor(e / 280); g < d.Lf.length && a + 280 <= c;) {
                        ...
                        D[b + a >> 2] = J[0];
                        D[b + a + 4 >> 2] = J[1];
                        J = [280 * (g + 1) >>> 0, (H = 280 * (g + 1), 1 <= +Math.abs(H) ?
                            0 < H ? (Math.min(+Math.floor(H / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((H - +(~~H >>> 0)) / 4294967296) >>> 0 : 0)];
                        D[b + a + 8 >> 2] = J[0];
                        D[b + a + 12 >> 2] = J[1];
                        Sa[b + a + 16 >> 1] = 280;
                        v[b + a + 18 >> 0] = r;
                ...
                try {
                    if (-1 === (a | 0) || 0 === b) var c = -28; else {
                        ...
                        if (d && b === d.ui) {
                            var e = N.zf(d.fd);
                            if (d.Gi & 2) {
                                var g = d.flags, k = d.offset, m = Ka.slice(a, a + b);
                                N.Xf(e, m, k, b, g)
                            }
                            hc[a] = null;
                            d.Jg && Bb(d.xi)
            ...
            function zc(a, b, c) {
                ...
                try {
                    for (var d = c = 0; d < b; d++) {
                        var e = a + 8 * d, g = Sa[e + 4 >> 1], k = 32, m = N.zf(D[e >> 2]);
            ...
            var Q = {
                jf: function () {
                    ...
                    b &= -526337;
                    c && assert(1 == b == (6 == c));
                    a = {family: a, type: b, protocol: c, lf: null, error: null, ng: {}, pending: [], ag: [], pf: Q.qf};
                    b = Q.zg();
                    ...
                    tg: function (a, b, c) {
                        ...
                        if (d) if (d._socket) b = d._socket.remoteAddress, c = d._socket.remotePort; else {
                            c = /ws[s]?:\/\/([^:]+):(\d+)/.exec(d.url);
                            if (!c) throw Error("WebSocket URL must be in the format ws(s)://address:port");
                            b = c[1];
                            c = parseInt(c[2], 10)
                        } else try {
                            var e = f.websocket && "object" === typeof f.websocket, g = "ws:#".replace("#", "//");
                            ...
                            var m = void 0;
                            "null" !== k && (k = k.replace(/^ +| +$/g, "").split(/ *, */), m = l ? {protocol: k.toString()} : k);
                        ...
                        var b = 0, c = 1 === a.type ? Q.qf.vg(a, a.sf, a.vf) : null;
                        ...
                        if ("undefined" !== typeof a.Bg ||
                            "undefined" !== typeof a.Qf) throw new N.af(28);
                        a.Bg = b;
                        a.Qf = c;
                        if (2 === a.type) {
                        ...
                        var d = c.data.byteLength || c.data.length, e = c.data.byteOffset || 0,
                            g = c.data.buffer || c.data;
                        b = Math.min(b, d);
                        var k = {
                            buffer: new Uint8Array(g, e, b), hf: c.hf,
                            port: c.port
                        };
            ...
            function Fc(a) {
                ...
                for (b = c = 0; b < a.length; b++) if ("string" === typeof a[b]) if ("Z" === a[b]) {
                    ...
                    --c
                } else d[b + c] = Gc(parseInt(a[b], 16)); else d[b + c] = a[b];
            ...
            function Rc(a, b) {
                ...
                try {
                    ...
                    switch (a) {
                        case 1:
                            var d = P(), e = P(), g = P(), k = Q.createSocket(d, e, g);
                            return k.stream.fd;
                        case 2:
                            k = b();
                            var m = c();
                        ...
                        case 15:
                            k = b();
                            var V = P(), fb = P(), K = P(), X = P();
                            return 1 === V && 4 === fb ? (D[K >> 2] = k.error, D[X >> 2] = 4, k.error = null, 0) : -50;
                        case 16:
                            k = b();
                            w = P();
                            P();
                            var ha = D[w + 8 >> 2], na = D[w + 12 >> 2], ua = D[w >> 2], ie = D[w + 4 >> 2];
                            if (ua) {
                                m = Pc(ua, ie);
                                if (m.ef) return -m.ef;
                                var je = m.port;
                            ...
                            for (W = B = 0; W < na; W++) {
                                var bc = D[ha + 8 * W >> 2], cc = D[ha + (8 * W + 4) >> 2];
            ...
            var $c = 1, ad = [], R = [], bd = [], cd = [], dd = [], S = [], ed = [], fd = [], gd = [], hd = {}, id = {},
                jd = 4;
            ...
            function wd(a, b, c, d) {
                if (c) if (a = U.getUniform(R[a], S[b]), "number" == typeof a || "boolean" == typeof a) switch (d) {
                    case 0:
                        D[c >> 2] = a;
                        break;
                    case 2:
            ...
            function xd(a, b, c, d) {
                if (c) if (a = U.getVertexAttrib(a, b), 34975 == b) D[c >> 2] = a && a.name; else if ("number" == typeof a || "boolean" == typeof a) switch (d) {
                    case 0:
                        D[c >> 2] = a;
                        break;
                    case 2:
            ...
            function yd(a, b, c, d, e) {
                ...
                var g = 31 - Math.clz32(a.BYTES_PER_ELEMENT), k = jd;
            ...
            var Jd = ["default", "low-power", "high-performance"], Kd = {};
                ...
                try {
                    a:{
                        for (var e = kc(a), g = a = 0; g < c; g++) {
                            var k = D[b + (8 * g + 4) >> 2], m = N.read(e, v, D[b + 8 * g >> 2], k, void 0);
                            if (0 > m) {
                                var r = -1;
                                break a
                            }
            ...
            function Ud(a, b, c, d) {
                ...
                a = A(a);
                g = Ec(a);
                if (null !== g) if (0 === r || 2 === r) r = 2; else if (10 === r && m & 8) g = [0, 0, Vd(65535), g], r = 10; else return -2; else if (g = Fc(a), null !== g) if (0 === r || 10 === r) r = 10; else return -2;
                if (null != g) return a = e(r, q, t, a, g, k), D[d >> 2] = a, 0;
                if (m & 4) return -2;
                a = Kc(a);
                g = Ec(a);
                0 === r ? r = 2 : 10 === r && (g = [0, 0, Vd(65535),
                    g]);
                a = e(r, q, t, null, g, k);
                D[d >> 2] = a;
                return 0
            ...
            function ce(a, b) {
                for (a = new Date(a.getTime()); 0 < b;) {
                    var c = a.getMonth(), d = (Zd(a.getFullYear()) ? ae : be)[c];
            ...
            var Ge = {
                c: function (a, b, c, d) {
                    ...
                    return Ob(a, b)
                }, Ma: lc, Ea: mc, u: nc, Na: oc, Ka: pc, Ha: qc, V: sc, Oa: tc, Pa: uc, ya: vc, Aa: function () {
                    return 0
                }, za: xc, Da: function () {
                    return -63
                }, Y: yc, La: zc, Ja: Ac, Ca: Bc, wa: Cc, Ga: Dc,
                Ia: function () {
                    return 0
                }, t: Rc, X: Sc, Fa: function (a) {
                    try {
                        if (!a) return -21;
                        var b = {
                            __size__: 390,
                ...
                }, Ba: Tc, pa: function (a, b) {
                    if (a == b) postMessage({cmd: "processQueuedMainThreadWork"}); else if (n) postMessage({
                        targetThread: a,
                    ...
                    Dd.length = 0;
                    var d;
                    for (c >>= 2; d = Ka[b++];) (d = 105 > d) && c & 1 && c++, Dd.push(d ? Ua[c++ >>
                    1] : D[c]), ++c;
                    return ob[a].apply(null, Dd)
                }, qa: Vc, I: function () {
                }, A: Wc, p: vb, z: Eb, Ed: function (a) {
                    U.activeTexture(a)
                }, Dd: function (a, b) {
                    ...
                    for (var c = 0; c < a; c++) {
                        var d = D[b + 4 * c >> 2], e = ad[d];
                        e && (U.deleteBuffer(e), e.name = 0, ad[d] = null)
                    }
                }, bd: function (a, b) {
                    for (var c = 0; c < a; ++c) {
                        var d = D[b + 4 * c >> 2], e = bd[d];
                ...
                Mc: function (a, b, c, d) {
                    ...
                    if (c) if (a >= $c) T(1281); else {
                        var d = hd[a];
                        if (d) if (35716 == b) a = U.getProgramInfoLog(R[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a.length + 1; else if (35719 ==
                            b) D[c >> 2] = d.Xg; else if (35722 == b) {
                            if (-1 == d.jg) {
                                a = R[a];
                            ...
                            D[c >> 2] = d.kg
                        } else D[c >> 2] = U.getProgramParameter(R[a], b); else T(1282)
                    } else T(1281)
                }, Od: function (a, b, c) {
                    if (c) {
                    ...
                    c ? D[c >> 2] = U.getRenderbufferParameter(a,
                        b) : T(1281)
                }, qc: function (a, b, c, d) {
                    ...
                    c ? 35716 == b ? (a = U.getShaderInfoLog(ed[a]), null === a && (a = "(unknown error)"), D[c >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = U.getShaderSource(ed[a]), D[c >> 2] = a ? a.length +
                    ...
                    c ? D[c >> 2] = U.getVertexAttribOffset(a,
                        b) : T(1281)
                }, hc: function (a, b, c) {
                    xd(a, b, c, 2)
                }, gc: function (a, b, c) {
                    ...
                    for (var c = a.Nh, d = U.getProgramParameter(b, 35718), e = 0; e < d; ++e) {
                        var g = U.getActiveUniform(b, e), k = g.name;
                    ...
                    if (96 >= b) for (var d = zd[3 * b - 1], e = 0; e < 3 * b; e += 3) d[e] = F[c + 4 * e >> 2], d[e + 1] = F[c + (4 * e + 4) >> 2], d[e + 2] =
                        F[c + (4 * e + 8) >> 2]; else d = F.subarray(c >> 2, c + 12 * b >> 2);
                    U.uniform3fv(S[a], d)
                }, rb: function (a, b, c, d) {
                    ...
                    da(a)
                }, H: Nd, U: Od, xa: Pd, Va: Qd, M: Rd, B: Td, d: function () {
                    return Aa | 0
                }, y: Ud, v: function (a, b, c, d, e, g, k) {
                    b = Pc(a, b);
                    if (b.ef) return -6;
                    a = b.port;
                    var m = b.hf;
                    ...
                    L.pi()
                }, ba: oe, j: pe, h: qe, C: re, P: se, _: te, O: ue, Xa: ve, Wa: we, k: xe, w: ye, J: ze, g: Ae, N: Be,
                Sa: Ce, Z: De, Ya: Ee, q: Ob, a: Ca || f.wasmMemory, T: function (a) {
                    Kb();
                    var b = new Date(D[a + 20 >> 2] + 1900, D[a + 16 >> 2], D[a + 12 >> 2], D[a + 8 >> 2], D[a + 4 >> 2], D[a >> 2], 0),
                        c = D[a + 32 >> 2], d = b.getTimezoneOffset(), e = new Date(b.getFullYear(), 0, 1),
                        g = (new Date(b.getFullYear(), 6, 1)).getTimezoneOffset(), k = e.getTimezoneOffset(),
                        m = Math.min(k, g);
                    ...
                    if (b) {
                        ...
                        k = 0 !== D[b + 12 >> 2];
                        if (0 === D[b + 16 >> 2]) {
                            var t = D[b + 20 >> 2], w = D[b + 24 >> 2];
                            m = b + 20;
                            r = b + 24;
                            var B = L.Mg ? L.Mg : rb | 0;
                            if (m || r) if (B) if (D[B + 12 >> 2] !== B) h("pthread_getschedparam attempted on thread " +
                                B + ", which does not point to a valid thread, or does not exist anymore!"); else {
                    ...
                    D[a >> 2] = a;
                    c = {
                        Rf: g, cg: q, Kg: b, Ih: m, Jh: r, detached: k, Mi: c, $f: t,
                        Fi: rb | 0, Tf: d, Vi: e
                    };
                    ...
                    function r(p) {
                        ...
                        var x = new Date(p.getFullYear() + 1, 0, 4), z = m(new Date(p.getFullYear(), 0, 4));
                        x = m(x);
                    ...
                    q = {
                        "%a": function (p) {
                            ...
                            var x = new Date(p.rf + 1900, 0, 1), z = 0 === x.getDay() ? x : ce(x, 7 - x.getDay());
                            ...
                            var x = new Date(p.rf + 1901, 0, 4), z = m(new Date(p.rf + 1900, 0, 4));
                            x = m(x);
            ...
            (function () {
                ...
                (function () {
                    return Ba || "function" !== typeof WebAssembly.instantiateStreaming || kb() || ib("file://") ||
                    "function" !== typeof fetch ? c(b) : fetch(jb, {credentials: "same-origin"}).then(function (e) {
            ...
            function Me(a) {
                ...
                if (!(0 < cb)) {
                    if (!n) {
                        if (f.preRun) for ("function" ==
                                           typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length;) bb();
                        pb(Xa)
                    }
